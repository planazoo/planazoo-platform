# Usuarios / auth — índice de proceso

> **Stub vivo** (Ago 2026). Histórico: [`archivo/FLUJO_CRUD_USUARIOS.md`](./archivo/FLUJO_CRUD_USUARIOS.md) (incluye snapshot Hive `current_user`).
...
- Auth providers / `UserService` en `lib/features/auth/`
