    ...
    try {
      ...
      if (mounted) {
        if (announcementId != null) {
          // Las notificaciones in-app se crean en Cloud Function onCreateAnnouncementNotifyParticipants
          // (el cliente no puede escribir en users/{otro}/notifications por reglas de Firestore)
